        ...
        <aside className={`w-full md:w-64 p-4 space-y-2 md:border-r ${darkMode ? "bg-slate-950/50 border-slate-800" : "bg-white border-slate-200"}`}>
          <button
            ...
            className={`w-full text-left py-3 px-4 rounded-xl text-sm font-bold flex items-center gap-3 transition-all cursor-pointer ${
              activeTab === "progreso" ? "bg-indigo-600 text-white shadow-lg shadow-indigo-600/20" : darkMode ? "text-slate-400 hover:bg-slate-850 hover:text-white" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900"
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left py-3 px-4 rounded-xl text-sm font-bold flex items-center gap-3 transition-all cursor-pointer ${
              activeTab === "historial" ? "bg-indigo-600 text-white shadow-lg shadow-indigo-600/20" : darkMode ? "text-slate-400 hover:bg-slate-850 hover:text-white" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900"
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left py-3 px-4 rounded-xl text-sm font-bold flex items-center gap-3 transition-all cursor-pointer ${
              activeTab === "tareas" ? "bg-indigo-600 text-white shadow-lg shadow-indigo-600/20" : darkMode ? "text-slate-400 hover:bg-slate-850 hover:text-white" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900"
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left py-3 px-4 rounded-xl text-sm font-bold flex items-center gap-3 transition-all cursor-pointer ${
              activeTab === "perfil" ? "bg-indigo-600 text-white shadow-lg shadow-indigo-600/20" : darkMode ? "text-slate-400 hover:bg-slate-850 hover:text-white" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900"
            }`}
          >
